...
ORDER_EMAIL_HOST_USER = env_str("ORDER_EMAIL_HOST_USER", EMAIL_HOST_USER)
ORDER_EMAIL_HOST_PASSWORD = env_str("ORDER_EMAIL_HOST_PASSWORD", EMAIL_HOST_PASSWORD)

AUTH_EMAIL_HOST_USER = env_str("AUTH_EMAIL_HOST_USER", EMAIL_HOST_USER)
AUTH_EMAIL_HOST_PASSWORD = env_str("AUTH_EMAIL_HOST_PASSWORD", EMAIL_HOST_PASSWORD)
...
MOYSKLAD_TOKEN_ADMIN = env_str("MOYSKLAD_TOKEN_ADMIN", "")
...
CELERY_BEAT_SCHEDULE = {
    "moysklad-inventory-every-minute": {
