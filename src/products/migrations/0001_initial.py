# Generated by Django 5.1.6 on 2025-08-25 12:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.CharField(max_length=128, unique=True, validators=[django.core.validators.RegexValidator('^[A-Za-z0-9._-]+$')])),
                ...
                ('volume', models.DecimalField(blank=True, decimal_places=6, max_digits=10, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0'))], verbose_name='Объем, м³')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wb_article', models.CharField(blank=True, max_length=64, null=True)),
                ('ozon_article', models.CharField(blank=True, max_length=64, null=True)),
