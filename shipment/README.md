...
API-учётки WB/Ozon/МойСклад приложение по-прежнему принимает через собственное окно настроек и хранит в HttpOnly cookies. Они не кладутся в образ Docker.
