  ...
  $.ajax({
    ...
    success: function(response) {
      ...
      items.forEach(function(item) {
        ...
        var errorText = $('<p>').addClass('text-danger').attr('id', 'error-text').text('Недопустимое количество товаров. Максимум: ' + item.stock_count);
        ...
        if (item.quantity > item.stock_count || isCheckoutBlocked) {
