...
class Product(models.Model):
	...
	light_inventory = models.PositiveSmallIntegerField('Наличие LightShop', null=True, default=0)
	mightbe_inventory = models.PositiveSmallIntegerField('Наличие MightBe', null=True, default=0)
